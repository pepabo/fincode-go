						...
						case 'c': // Prefix: "ca"
							...
							case 'p': // Prefix: "pture"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "PUT":
										s.handlePaymentsIDCapturePutRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, "PUT")
			...
			case 'c': // Prefix: "customers"
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						switch method {
						case "DELETE":
							r.name = CustomersIDDeleteOperation
							r.summary = ""
							r.operationID = ""
							...
							return r, true
						case "GET":
							r.name = CustomersIDGetOperation
							r.summary = ""
							r.operationID = ""
							r.pathPattern = "/customers/{id}"
							r.args = args
					...
					case '/': // Prefix: "/"
						...
						case 'c': // Prefix: "cards/"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "DELETE":
									r.name = CustomersCustomerIDCardsIDDeleteOperation
									r.summary = ""
									r.operationID = ""
									...
									return r, true
								case "GET":
									r.name = CustomersCustomerIDCardsIDGetOperation
									r.summary = ""
									r.operationID = ""
									r.pathPattern = "/customers/{customer_id}/cards/{id}"
									r.args = args
						...
						case 'p': // Prefix: "payment_methods"
							...
							if len(elem) == 0 {
								switch method {
								case "POST":
									r.name = CustomersCustomerIDPaymentMethodsPostOperation
									r.summary = ""
									r.operationID = ""
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "DELETE":
										r.name = CustomersCustomerIDPaymentMethodsPaymentMethodIDDeleteOperation
										r.summary = ""
										r.operationID = ""
										...
										return r, true
									case "GET":
										r.name = CustomersCustomerIDPaymentMethodsPaymentMethodIDGetOperation
										r.summary = ""
										r.operationID = ""
										r.pathPattern = "/customers/{customer_id}/payment_methods/{payment_method_id}"
										r.args = args
					...
					case '/': // Prefix: "/"
						...
						case 'a': // Prefix: "auth"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "PUT":
									r.name = PaymentsIDAuthPutOperation
									r.summary = ""
									r.operationID = ""
						...
						case 'c': // Prefix: "ca"
							...
							case 'n': // Prefix: "ncel"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "PUT":
										r.name = PaymentsIDCancelPutOperation
										r.summary = ""
										r.operationID = ""
							...
							case 'p': // Prefix: "pture"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "PUT":
										r.name = PaymentsIDCapturePutOperation
										r.summary = ""
										r.operationID = ""
										r.pathPattern = "/payments/{id}/capture"
										r.args = args
										r.count = 1
										return r, true
									default:
