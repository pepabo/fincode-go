...
// PaymentsIDCapturePutParams is parameters of PUT /payments/{id}/capture operation.
type PaymentsIDCapturePutParams struct {
	ID string
}

func unpackPaymentsIDCapturePutParams(packed middleware.Parameters) (params PaymentsIDCapturePutParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodePaymentsIDCapturePutParams(args [1]string, argsEscaped bool, r *http.Request) (params PaymentsIDCapturePutParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
