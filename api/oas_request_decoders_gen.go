...
func (s *Server) decodePaymentsIDAuthPutRequest(r *http.Request) (
	req PaymentsIDAuthPutReq,
	close func() error,
	rerr error,
) {
	var closers []func() error
	...
	case ct == "application/json":
		...
		var request PaymentsIDAuthPutReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePaymentsIDCancelPutRequest(r *http.Request) (
	req PaymentsIDCancelPutReq,
	close func() error,
	rerr error,
) {
	var closers []func() error
	...
	case ct == "application/json":
		...
		var request PaymentsIDCancelPutReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodePaymentsIDCapturePutRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request PaymentsIDCapturePutReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
